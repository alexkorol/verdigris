...
prints the load-adaptive timing guard and event-loop diagnostics; default mode
uses those observed p99/max scheduler delays to add bounded slack, while a
