...
$manifests = @('inventory', 'terrain', 'props', 'gate', 'actors', 'bestiary', 'weapons', 'hero-single', 'bestiary-singles', 'hero-walk', 'hero-directions', 'environment-singles', 'large-props', 'hero-strike-se', 'hit-spark', 'hero-walk-sw', 'hero-walk-nw', 'hero-walk-ne', 'hero-strike-nw', 'hero-strike-sw', 'terrain-quiet', 'raider-walk-sw')
