...
manifest_path=TOOLS/'raider-walk-sw-axe-v3-candidate.json'
manifest=json.loads(manifest_path.read_text())
source=np.array(Image.open(ROOT/'native/client/assets/raster/source/raider-walk-sw-axe-v3.png').convert('RGBA'))
...
scopes.extend([{'kind':'axe/knee background','frame':4,'box':[110,770,135,805]},
               {'kind':'axe/knee background','frame':5,'box':[510,773,538,802]}])
windows=[]
for scope in scopes:
