...
Expanded sheet paints Conditional once; a duplicate Conditional cannot
certify. Slice builds on the sheet are role | gear chips; tactics stay on
HUD ops. A dormant conditional cannot fold into Attack. Core STAT stays
Kimi. WASD stays off the C-key sheet. The sheet sits below the minimap
and above Life. The close hint stays in the slot. Scenario
