...
CURSOR = {
    ...
    "VG-UI-001": ("extend", "pane-stack native Escape; helper depth alone cannot prove"),
    ...
    "VG-UI-004": ("extend", "stat-explain expandable ATK; dormant cannot fold into Attack; core STAT stays Kimi"),
    ...
    "VG-UI-007": ("extend", "hud-scale-floor + hud-pane-readability + vital-orbs roles"),
