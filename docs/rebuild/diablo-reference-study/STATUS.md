...
September 10 pursuit milestone: native bounded pursuit/shared collision, fixed50ms input batches, immutable event poses, corrected local-session identity/coordinates and scene collision lifecycle. NE6/NW8 add14 exact Pixel Respecter outputs:162 assets/29 manifests/55 sources, all148 prior PNGs unchanged; SE rejected. Entry visibility now protects hero/stair art, verified by the final Tin2 capture after rejecting collision-only clearance. Final supported build/all71 scenarios pass; native suites, browser32/32, importer10/10 and equipment/sampling pass. Fullscreen static/moving23.283/25.402ms, moving peak34.124ms;40ms average bounds unchanged. Root viewed native/production frames and live3440x1440. Both idle local live sessions died during observation; gear input and clean exit were verified, but manual combat completion is not claimed. Opening pace, remaining motion/identity and the broader pixel-world goal remain IN_PROGRESS. Evidence: native/client/assets/raster/reviews/2026-09-10-pursuit/README.md. No push or merge.


September 10 normal-server milestone: real WorldSimulation melee pursuit and immediate scene-scoped movement delivery now reach the normal native client, with display-only interpolation and retained facing/rarity through contact. Published PURESO walking and Higgsfield per-frame guide workflows produced cleaned SW8 wight and SE4 raider candidates; 174 assets/31 manifests/60 sources/183 import records, all162 prior PNGs unchanged. Supported native build/all suites/all72 scenarios, browser32/32, importer10/10 and equipment/sampling pass. Root viewed native/production phase images, actual crypt contact/stop/re-entry and the normal live3440x1440 launch, House/Scion creation, expedition entry and F3. Manual fight/movement completion is not claimed. Flat remote walls, noisy ground, other motion and identity polish remain IN_PROGRESS. Evidence: native/client/assets/raster/reviews/2026-09-10-monster-motion/README.md. No push or merge.
