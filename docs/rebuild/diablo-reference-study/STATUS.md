...
- scope: read-only Diablo reference inspection; independent native attack-cadence correction; regression tests; source/evidence record
- original installation: no patches or archive writes; D2R launched for attempted observation
