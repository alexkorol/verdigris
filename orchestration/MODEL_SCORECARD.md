...
| Cursor Grok 4.6 (Cursor desktop) | native C++ features + CI | 7 | 0061 rubric miss then 6 straight first-pass (Gate A 12/12) | 0 | protocol/session/render/bench all strong; honest gap notes; give explicit presentation-quality constraints in SPECs |
