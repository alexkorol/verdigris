---
task: TASK-0187
title: Native attack arcs and trails integration
state: AUTO_RELEASE
...
dependencies: [TASK-0174 ACCEPTED; TASK-0186 ACCEPTED]
owner_input_dependency: none unless dependency records a new owner-only gate
likely_paths: [native/client/main.cpp, orchestration/tasks/TASK-0187-native-combat-vfx-integration/**]
...
Render visible swings, thrusts, slams, trails, and impacts synchronized with events.
