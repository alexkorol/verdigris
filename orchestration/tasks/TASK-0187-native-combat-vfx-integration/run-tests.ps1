# TASK-0187 layout prep acceptance harness.
param()
...
$testSource = Join-Path $taskDir "combat_vfx_layout_tests.cpp"
$testObject = Join-Path $buildDir "combat_vfx_layout_tests.obj"
$testExe = Join-Path $buildDir "combat_vfx_layout_tests.exe"
...
Write-Host "TASK-0187 combat_vfx_layout planner: PASS"
