---
task: TASK-0199
title: Early Bond progress visibility
state: AUTO_RELEASE
...
dependencies: [TASK-0198 ACCEPTED]
owner_input_dependency: none unless dependency records a new owner-only gate
likely_paths: [native/client/main.cpp, orchestration/tasks/TASK-0199-bond-progress-visibility/**]
...
Show slow incomplete early Bond progress from item use.
