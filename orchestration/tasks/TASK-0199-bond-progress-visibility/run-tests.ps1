# TASK-0199 model-slice acceptance harness.
param()
...
$testSource = Join-Path $taskDir "bond_progress_tests.cpp"
$testObject = Join-Path $buildDir "bond_progress_tests.obj"
$testExe = Join-Path $buildDir "bond_progress_tests.exe"
...
Write-Host "TASK-0199 bond progress model slice: PASS"
