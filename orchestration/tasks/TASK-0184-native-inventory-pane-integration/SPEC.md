---
task: TASK-0184
title: Native grid inventory and paper-doll integration
state: AUTO_RELEASE
...
dependencies: [TASK-0171 ACCEPTED; TASK-0172 ACCEPTED; TASK-0180 ACCEPTED; TASK-0182 ACCEPTED]
owner_input_dependency: none unless dependency records a new owner-only gate
likely_paths: [native/client/main.cpp, orchestration/tasks/TASK-0184-native-inventory-pane-integration/**]
...
Replace list rectangle with Framekit grid backpack, paper doll, hover, and real art.
