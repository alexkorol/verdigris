# TASK-0184 layout prep acceptance harness.
param()
...
$testSource = Join-Path $taskDir "inventory_pane_layout_tests.cpp"
$testObject = Join-Path $buildDir "inventory_pane_layout_tests.obj"
$testExe = Join-Path $buildDir "inventory_pane_layout_tests.exe"
...
Write-Host "TASK-0184 inventory_pane_layout planner: PASS"
