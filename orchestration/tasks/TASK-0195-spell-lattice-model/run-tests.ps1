...
$testSource = Join-Path $taskDir "spell_lattice_tests.cpp"
$testObject = Join-Path $buildDir "spell_lattice_tests.obj"
$testExe = Join-Path $buildDir "spell_lattice_tests.exe"
...
Write-Host "TASK-0195 spell lattice acceptance harness: PASS"
