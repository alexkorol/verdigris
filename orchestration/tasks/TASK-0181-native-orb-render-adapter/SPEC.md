---
task: TASK-0181
title: Native WIZARD orb render adapter
state: AUTO_RELEASE
...
dependencies: [TASK-0168 ACCEPTED]
owner_input_dependency: none unless dependency records a new owner-only gate
likely_paths: [native/client/orb_renderer.hpp, orchestration/tasks/TASK-0181-native-orb-render-adapter/**]
...
Render layered WIZARD life/mana states from authoritative ratios with low-resource feedback.
