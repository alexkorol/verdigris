# TASK-0194 layout prep acceptance harness.
param()
...
$testSource = Join-Path $taskDir "skill_tree_layout_tests.cpp"
$testObject = Join-Path $buildDir "skill_tree_layout_tests.obj"
$testExe = Join-Path $buildDir "skill_tree_layout_tests.exe"
...
Write-Host "TASK-0194 skill_tree_layout planner: PASS"
