---
task: TASK-0194
title: First level-up skill-tree integration
state: AUTO_RELEASE
...
dependencies: [TASK-0193 ACCEPTED]
owner_input_dependency: none unless dependency records a new owner-only gate
likely_paths: [native/client/main.cpp, orchestration/tasks/TASK-0194-geometric-skill-tree-integration/**]
...
On boss level-up notify and open recognizable geometric tree with one spendable point.
