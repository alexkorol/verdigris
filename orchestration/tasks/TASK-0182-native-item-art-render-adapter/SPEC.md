---
task: TASK-0182
title: Native item-art render adapter
state: AUTO_RELEASE
...
dependencies: [TASK-0169 ACCEPTED]
owner_input_dependency: none unless dependency records a new owner-only gate
likely_paths: [native/client/item_art_renderer.hpp, orchestration/tasks/TASK-0182-native-item-art-render-adapter/**]
...
Map stable item ids and footprints to real RPG Inventory art with deterministic fallback diagnostics.
