# TASK-0188 layout prep acceptance harness.
param()
...
$testSource = Join-Path $taskDir "gate_overlay_layout_tests.cpp"
$testObject = Join-Path $buildDir "gate_overlay_layout_tests.obj"
$testExe = Join-Path $buildDir "gate_overlay_layout_tests.exe"
...
Write-Host "TASK-0188 gate_overlay_layout planner: PASS"
