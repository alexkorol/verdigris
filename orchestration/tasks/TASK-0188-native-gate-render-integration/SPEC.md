---
task: TASK-0188
title: Native readable gate integration
state: AUTO_RELEASE
...
dependencies: [TASK-0175 ACCEPTED; TASK-0178 ACCEPTED]
owner_input_dependency: none unless dependency records a new owner-only gate
likely_paths: [native/client/main.cpp, orchestration/tasks/TASK-0188-native-gate-render-integration/**]
...
Render highlighted physical gates with destination labels and normal/Ctrl-click interaction.
