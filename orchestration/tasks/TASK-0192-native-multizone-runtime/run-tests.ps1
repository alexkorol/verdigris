# TASK-0192 bridge prep acceptance harness.
param()
...
$testSource = Join-Path $taskDir "zone_runtime_bridge_tests.cpp"
$testObject = Join-Path $buildDir "zone_runtime_bridge_tests.obj"
$testExe = Join-Path $buildDir "zone_runtime_bridge_tests.exe"
...
Write-Host "TASK-0192 zone_runtime_bridge: PASS"
