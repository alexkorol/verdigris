---
task: TASK-0207
title: Owner Demo native performance gate
state: AUTO_RELEASE
...
dependencies: [TASK-0205 ACCEPTED]
owner_input_dependency: none unless dependency records a new owner-only gate
likely_paths: [native/tools/owner_demo_bench.cpp, orchestration/tasks/TASK-0207-owner-demo-performance-budget/**]
...
Measure frame pacing and simulation/network headroom through actual Owner journey.
