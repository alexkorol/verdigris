# TASK-0185 layout prep acceptance harness.
param()
...
$testSource = Join-Path $taskDir "orb_hud_layout_tests.cpp"
$testObject = Join-Path $buildDir "orb_hud_layout_tests.obj"
$testExe = Join-Path $buildDir "orb_hud_layout_tests.exe"
...
Write-Host "TASK-0185 orb_hud_layout planner: PASS"
