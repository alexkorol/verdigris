---
task: TASK-0185
title: Native WIZARD orb HUD integration
state: AUTO_RELEASE
...
dependencies: [TASK-0181 ACCEPTED]
owner_input_dependency: none unless dependency records a new owner-only gate
likely_paths: [native/client/main.cpp, orchestration/tasks/TASK-0185-native-orb-hud-integration/**]
...
Replace crude circles with WIZARD life/mana orbs driven by authoritative state.
