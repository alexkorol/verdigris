# TASK-0189 bridge prep acceptance harness.
param()
...
$testSource = Join-Path $taskDir "instance_gate_bridge_tests.cpp"
$testObject = Join-Path $buildDir "instance_gate_bridge_tests.obj"
$testExe = Join-Path $buildDir "instance_gate_bridge_tests.exe"
...
Write-Host "TASK-0189 instance_gate_bridge: PASS"
