---
task: TASK-0189
title: Native persistent instance refresh integration
state: AUTO_RELEASE
...
dependencies: [TASK-0176 ACCEPTED; TASK-0188 ACCEPTED]
owner_input_dependency: none unless dependency records a new owner-only gate
likely_paths: [native/src/networking.cpp, orchestration/tasks/TASK-0189-native-instance-lifecycle-integration/**]
...
Implement authoritative instance reuse/expiry and explicit fresh requests without refreshing town.
