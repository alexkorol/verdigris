---
task: TASK-0193
title: Geometric skill-tree native model
state: AUTO_RELEASE
...
dependencies: [TASK-0166 ACCEPTED]
owner_input_dependency: none unless dependency records a new owner-only gate
likely_paths: [native/client/geometric_skill_tree.hpp, orchestration/tasks/TASK-0193-geometric-skill-tree-model/**]
...
Adopt WIZARD geometric-tree data/geometry into deterministic native presentation model.
