...
$testSource = Join-Path $taskDir "geometric_skill_tree_tests.cpp"
$testObject = Join-Path $buildDir "geometric_skill_tree_tests.obj"
$testExe = Join-Path $buildDir "geometric_skill_tree_tests.exe"
...
Write-Host "TASK-0193 geometric skill tree acceptance harness: PASS"
