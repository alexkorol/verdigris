...
$testSource = Join-Path $taskDir "house_progression_tests.cpp"
$testObject = Join-Path $buildDir "house_progression_tests.obj"
$testExe = Join-Path $buildDir "house_progression_tests.exe"
...
Write-Host "TASK-0200 house progression acceptance harness: PASS"
