# TASK-0196 layout prep acceptance harness.
param()
...
$testSource = Join-Path $taskDir "spell_lattice_layout_tests.cpp"
$testObject = Join-Path $buildDir "spell_lattice_layout_tests.obj"
$testExe = Join-Path $buildDir "spell_lattice_layout_tests.exe"
...
Write-Host "TASK-0196 spell_lattice_layout planner: PASS"
