...
$testSource = Join-Path $taskDir "instance_refresh_tests.cpp"
$testObject = Join-Path $buildDir "instance_refresh_tests.obj"
$testExe = Join-Path $buildDir "instance_refresh_tests.exe"
...
Write-Host "TASK-0176 instance refresh acceptance harness: PASS"
