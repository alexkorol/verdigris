# TASK-0201 layout prep acceptance harness.
param()
...
$includeInclude = Join-Path $root "native\include"
...
$testSource = Join-Path $taskDir "house_investment_layout_tests.cpp"
$testObject = Join-Path $buildDir "house_investment_layout_tests.obj"
$testExe = Join-Path $buildDir "house_investment_layout_tests.exe"

$includeFlags = '/I"' + $clientInclude + '" /I"' + $includeInclude + '"'
...
Write-Host "TASK-0201 house_investment_layout planner: PASS"
