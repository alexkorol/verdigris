---
task: TASK-0186
title: Native animated actor integration
state: AUTO_RELEASE
...
dependencies: [TASK-0173 ACCEPTED]
owner_input_dependency: none unless dependency records a new owner-only gate
likely_paths: [native/client/main.cpp, orchestration/tasks/TASK-0186-native-animated-actor-integration/**]
...
Render animated actors with visible locomotion, attacks, hit reactions, and deaths.
