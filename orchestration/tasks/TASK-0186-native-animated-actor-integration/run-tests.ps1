# TASK-0186 bridge prep acceptance harness.
param()
...
$testSource = Join-Path $taskDir "actor_combat_bridge_tests.cpp"
$testObject = Join-Path $buildDir "actor_combat_bridge_tests.obj"
$testExe = Join-Path $buildDir "actor_combat_bridge_tests.exe"
...
Write-Host "TASK-0186 actor_combat_bridge: PASS"
