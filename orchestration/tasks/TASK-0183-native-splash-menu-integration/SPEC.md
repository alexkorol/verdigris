---
task: TASK-0183
title: Native splash and menu integration
state: AUTO_RELEASE
...
dependencies: [TASK-0170 ACCEPTED; TASK-0179 ACCEPTED; TASK-0180 ACCEPTED]
owner_input_dependency: none unless dependency records a new owner-only gate
likely_paths: [native/client/main.cpp, orchestration/tasks/TASK-0183-native-splash-menu-integration/**]
...
Integrate title, pause, resume, and explicit quit with splash/Framekit; Escape never exits directly.
