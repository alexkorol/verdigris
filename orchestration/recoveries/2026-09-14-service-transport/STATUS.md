...
- follow-up: parent assigned disjoint server entry, launcher and service package/operation paths in the same worktree; implementation and focused real-process checks complete, preparing branch push.
