...
Implemented and locally tested: 202 focused assertions, 16-thread races,
five real process crash recoveries, online backup/restore; production object
...
Schema three commits opaque global ownership state atomically with source and
recipient account snapshots and outcome IDs; parent owns relic-ledger behavior.
