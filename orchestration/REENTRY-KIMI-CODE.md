...
https://github.com/alexkorol/verdigris). git pull, checkout
codex/native-reconstitution, npm install.

Read in order: orchestration/ONBOARDING-KIMI.md, PROTOCOL.md,
DECISIONS.md (D-106..D-116 are owner canon), ARCHITECT_STATE.md (board
nudge near the end).
